...
namespace Volleyball.Infrastructure.Database.Migrations
{
    ...
    [Migration("20230608130213_VolleyballTrainingOrganizer")]
    partial class VolleyballTrainingOrganizer
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Volleyball.Infrastructure.Database.Models.TrainingGroupTrainingParticipant", b =>
                {
                    ...
                    b.HasKey("TrainingGroupId", "TrainingParticipantId");

                    b.HasIndex("TrainingParticipantId");

                    b.ToTable("TrainingGroupTrainingParticipants");
                });
            ...
            modelBuilder.Entity("Volleyball.Infrastructure.Database.Models.TrainingTrainingParticipant", b =>
                {
                    ...
                    b.HasKey("TrainingId", "TrainingParticipantId");

                    b.HasIndex("TrainingParticipantId");

                    b.ToTable("TrainingTrainingParticipants");
                });
            ...
            modelBuilder.Entity("Volleyball.Infrastructure.Database.Models.TrainingGroupTrainingParticipant", b =>
                {
                    b.HasOne("Volleyball.Infrastructure.Database.Models.TrainingGroup", "TrainingGroup")
                        .WithMany("TrainingGroupTrainingParticipants")
                        .HasForeignKey("TrainingGroupId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Volleyball.Infrastructure.Database.Models.TrainingParticipant", "TrainingParticipant")
                        .WithMany("TrainingGroupTrainingParticipants")
            ...
            modelBuilder.Entity("Volleyball.Infrastructure.Database.Models.TrainingTrainingParticipant", b =>
                {
                    b.HasOne("Volleyball.Infrastructure.Database.Models.Training", "Training")
                        .WithMany("TrainingParticipants")
            ...
            modelBuilder.Entity("Volleyball.Infrastructure.Database.Models.TrainingGroup", b =>
                {
                    b.Navigation("TrainingGroupTrainingParticipants");
                });
